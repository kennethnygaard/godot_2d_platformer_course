...
func aquire_target_position():
	var aquired = get_target_position_from_group_name("player")
	if(!aquired):
		get_target_position_from_group_name("player_death")

			
func get_target_position_from_group_name(groupName):
